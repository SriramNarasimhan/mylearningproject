...
/**
 * WorkflowPackageManager interface to 
 * 
...
public interface WorkflowPackageManager {
    /**
     * Creates a Workflow Package for the provided paths. The Workflow Page will 
     * include the provided paths and any jcr:content sub-structure.
     *
     ...
     * - If the path does resolve to a Workflow Package > a List of all resources in the Workflow 
     * Package but not the WF Package itself.
     *
